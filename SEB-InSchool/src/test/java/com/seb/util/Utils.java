...
public class Utils {
	...
	public void clearandtype() throws TwfException, InterruptedException {
		WebDriver driver = DriverFactory.getDriver();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@class='form-control b-input-box ng-pristine ng-invalid ng-touched'])[1]")).clear();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@class='form-control b-input-box ng-pristine ng-invalid ng-touched'])[1]")).sendKeys("45000");
	}
